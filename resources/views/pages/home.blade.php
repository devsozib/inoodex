            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="hero-content layout2">
                  <h1>Build your Business <span>with Inoodex</span>
                  </h1>
                  <p>Let's build your ideal software organization together.Solutions and services for all your development</p>
                  <div class="buttons">
                    <div class="cmn-btn">
        ...
        <div class="container">
          <div class="title-wrap wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="sec-title white">
              ...
              <h2>Services</h2>
              <p>A strategy, design, and technology partner for forward-thinking companies and societies.Consultancy and agency services, built on exceptional technological competence.</p>
            </div>
          </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="single-service layout2">
                  ...
                  <p>We create large scale software, digital products, services, and strategies for your daily business.</p>
                  <div class="read-btn">
              ...
              <div class="swiper-slide wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="single-service layout2">
                  ...
                  <h4>Web Design</h4>
                  <p>Our team of web developers bring with them over a decade's worth of experience.</p>
                  <div class="read-btn">
                    <a href="service-details.html">Read More</a>
                  </div>
                </div>
              ...
              <div class="swiper-slide wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="single-service layout2">
                  ...
                  <p>We offer social media marketing services for creating unique campaigns for growing a business</p>
                  <div class="read-btn">
                    <a href="service-details.html">Read More</a>
                  </div>
                </div>
            ...
            <div class="col-lg-6 or-2 wow animate fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms">
              ...
              <div class="about-left layout2">
                ...
                <div class="company-since layout2">
                  ...
                  <strong>#1</strong>
                  <h4>We provide quality and professional Solutions <span>for growing your Business.</span>
                  </h4>
                </div>
              </div>
            </div>
              ...
              <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div class="price-box layout2">
                    ...
                    <strong>$15.99 <sub>/Per Month</sub>
                    </strong>
                    <ul class="item-list">
                      <li>
                        <i class="bi bi-check"></i>10 Pages Responsive Website
                      </li>
                      <li>
                        <i class="bi bi-check"></i>5PPC Campaigns
                      </li>
                      <li>
                        <i class="bi bi-check"></i>10 SEO Keyword
                      </li>
                      <li>
                        <i class="bi bi-check"></i>5 Facebook Camplaigns
                      </li>
                      <li>
                        <i class="bi bi-check"></i>2 Video Camplaigns
                      </li>
                    </ul>
                    <div class="price-btn">
                      <div class="line-1"></div>
                ...
                <div class="col-md-6 col-lg-4 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div class="price-box layout2">
                    ...
                    <strong>$99.99 <sub>/Per Month</sub>
                    </strong>
                    <ul class="item-list">
                      <li>
                        <i class="bi bi-check"></i>10 Pages Responsive Website
                ...
                <div class="col-md-6 col-lg-4 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div class="price-box layout2">
                    ...
                    <strong>$120.99 <sub>/Per Month</sub>
                    </strong>
                    <ul class="item-list">
                      <li>
                        <i class="bi bi-check"></i>10 Pages Responsive Website
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div class="price-box layout2">
                    <h3>Professional</h3>
                    <span>Small team</span>
                    <strong>$199.99 <sub>/Per Year</sub>
                    </strong>
                    <ul class="item-list">
                      <li>
                        <i class="bi bi-check"></i>10 Pages Responsive Website
                ...
                <div class="col-md-6 col-lg-4 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div class="price-box layout2">
                    <h3>Enterprice</h3>
                    <span>Large Team</span>
                    <strong>$220.99 <sub>/Per Year</sub>
                    </strong>
                    <ul class="item-list">
                      <li>
                        <i class="bi bi-check"></i>10 Pages Responsive Website
